                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="caption text-center  mt-0">
                            <h2 class="welcome-text text-white">Cerita Cintaku</h2>
                            <p class="small-welcome-text" >Bercerita tentang cinta, perjalanan bahagia pun duka. Tempat bagi kamu mencurahkan kisah, yang bersatu maupun berpisah</p>
        
                            <a href="/ceritacintaku/login.jsp" class="btn btn-second">Login</a>
        
                            <a href="/ceritacintaku/register.jsp" class="btn btn-second">Registration</a>
                        ...
                        <div class="feature-wrapper">
                            <div class="feature-text">
                                <div class="big-text-feature">
                                    <h3>Kita ada untuk kamu, kamu ada untuk kita</h3>
                                </div>
                                <div class="small-text-feature ">
                                    <p>
                                        Cerita Cintaku adalah wadah bagi insan menceritakan kisah cintanya
                                        Usia bukan penghalang untuk saling berbagi, lokasi penuh romansa
                                        untuk saling mengasihi. Berceritalah Cintaku.
                                    </p>
                                </div>
                            </div>
